...
return (
  <div className='App'>
    <div className='innerContainer'>
      <h1>Counter App</h1>
      <p style={{ textAlign: "center"}}>This is a counter application built by Ola, powered by React</p>
      <input type="input" value={counter} onChange={(e) => {setCounter(e.target.value)}}/>
        ...
        <p>Maximum</p>
        <input type="input" value={maximum} onChange={(e)=> {setMaximum(e.target.value)}}></input>
        <div className="buttonContainer">
        ...
        <p>Minimum</p>
        <input type="input" value={minimum} onChange={(e)=>{setMinimum(e.target.value)}}></input>
        <div className='buttonContainer'>
